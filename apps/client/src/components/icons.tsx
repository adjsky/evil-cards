...
export const Question: React.FC<{ width?: number; height?: number }> = ({
  width = 48,
  height = 48
}) => (
  <svg
  ...
  >
    <path
      d="M21.5843 34.8693V28.4598C21.5843 28.0196 21.8693 27.6312 22.2863 27.49C24.2761 26.8161 29.9149 24.7217 31.5434 22.1329C33.5321 18.9714 33.3419 11.9143 30.5038 9.08874C26.9264 5.52714 19.396 4.91314 17.0359 9.47413C15.7417 11.9753 16.2251 16.7786 16.2251 16.7786"
      stroke="#555555"
      strokeWidth="7"
      strokeLinecap="round"
    />
    <path
      d="M25.0565 42.3278C25.0565 44.2262 23.6043 45.7652 21.813 45.7652C20.0216 45.7652 18.5695 44.2262 18.5695 42.3278C18.5695 40.4293 20.0216 38.8903 21.813 38.8903C23.6043 38.8903 25.0565 40.4293 25.0565 42.3278Z"
      fill="#555555"
    />
  </svg>
)
